#Created by Anezka Kolaceke for the Kaggle Titanic Challenge
#See notebook at https://www.kaggle.com/anezka/titanic-problem/
...
def logistic_regression(X, Y, Xtest, alpha, nEpoch, sh, lamb=0):
...
def neural_network(X, Y, Xtest, alpha, nEpoch, sh):
